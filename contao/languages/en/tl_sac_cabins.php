...
$GLOBALS['TL_LANG']['tl_sac_cabins']['phone'] = ['Hüttentelefon', 'Bitte geben Sie die Nummer des Hüttentelefons ein.'];
$GLOBALS['TL_LANG']['tl_sac_cabins']['email'] = ['E-Mail-Adresse', 'Bitte geben Sie die E-Mail-Adresse ein.'];
$GLOBALS['TL_LANG']['tl_sac_cabins']['url'] = ['Hüttenwebseite', 'Bitte geben Sie die url der Hüttenwebseite ein (https://....).'];
...
$GLOBALS['TL_LANG']['tl_sac_cabins']['capacityShelterRoom'] = ['Schutzraum/Kapazität', 'Bitte geben Sie die Kapazität des Schutzraums ein.'];
...
$GLOBALS['TL_LANG']['tl_sac_cabins']['ascent'] = ['Zustiegsmöglichkeiten', 'Bitte geben Sie die Zustiegsmöglichkeiten ein.'];
$GLOBALS['TL_LANG']['tl_sac_cabins']['ascentDescription'] = ['Zustiegsmöglichkeiten', 'Bitte geben Sie die Zustiegsmöglichkeiten ein.'];
$GLOBALS['TL_LANG']['tl_sac_cabins']['ascentTime'] = ['Zustiegszeit', "Bite geben Sie die Zustiegszeit im Format 7 h 30' ein."];
$GLOBALS['TL_LANG']['tl_sac_cabins']['ascentDifficulty'] = ['Schwierigkeitsangaben', 'Bitte geben Sie die Schwierigkeitsangabe ein.'];
$GLOBALS['TL_LANG']['tl_sac_cabins']['ascentSummer'] = ['Sommerzustieg', 'Zustieg auf dieser Route im Sommer möglich? Ja/Nein.'];
$GLOBALS['TL_LANG']['tl_sac_cabins']['ascentWinter'] = ['Winterzustieg', 'Zustieg auf dieser Route im Winter möglich? Ja/Nein.'];
$GLOBALS['TL_LANG']['tl_sac_cabins']['ascentComment'] = ['Weitere Anmerkungen', 'Bitte geben Sie weitere Anmerkungen zum Zustieg ein.'];

// References
$GLOBALS['TL_LANG']['tl_sac_cabins']['possible'] = 'möglich';
$GLOBALS['TL_LANG']['tl_sac_cabins']['not-possible'] = 'nicht möglich';
